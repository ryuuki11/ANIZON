...
<body>
        ...
        <a href="hiroaka.html" class="back"><div class="buttn2"><button class="return">戻る</button></div></a>
    <div class="card">
        <p>カード名義</p>
    ...
    <a href="hirogacha.html" class="gacha"><div class="gachab"><button>ガチャへ</button></div></a>
</body>
</html>