...
if(empty($_POST['login']) || empty($_POST['password']) || empty($_POST['m_name']) || empty($_POST['post']) || empty($_POST['address']) || empty($_POST['mail']) || empty($_POST['number'])){
    ...
    if(!empty($sql->fetchAll())){
        ...
        $sql->execute ([
        $_POST['login'],$_POST['password'],$_POST['m_name'],$_POST['post'],$_POST['address'],$_POST['apart'],$_POST['mail'],$_POST['number']]);
